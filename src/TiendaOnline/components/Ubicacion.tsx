...
const UBICACION = {
  ...
  lng: -106.4473197,
  placeUrl:
    'https://www.google.com/maps/place/Sierra+India+217,+Lomas+de+Mazatl%C3%A1n,+82110+Mazatl%C3%A1n,+Sin.',
};
...
export const UbicacionComponent: React.FC<Props> = ({
  ...
  const mapsPlaceUrl = UBICACION.placeUrl;
              ...
              <div className="absolute left-3 bottom-3 z-10">
                {!interactive ? (
                  <button
                    ...
                    className="rounded-full border border-neutral-200 bg-white px-3 py-1.5 text-xs shadow hover:bg-neutral-50"
                  >

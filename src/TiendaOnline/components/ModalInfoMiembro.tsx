// components/ModalInfoMiembro.tsx
  ...
  return createPortal(
    <AnimatePresence>
      {open && member && (
        <motion.div
          ref={overlayRef}
          className="fixed inset-0 z-[100] bg-black/60 backdrop-blur-sm flex items-center justify-center px-2 md:px-4"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          aria-hidden={!open}
        ...
        >
          <motion.div
            ...
            className="
              relative w-[92%] max-w-[420px] md:max-w-3xl 
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto">
              <div className="p-5 md:p-6 grid gap-6 md:grid-cols-[260px,1fr]">
                {/* Imagen */}
